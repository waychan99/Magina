...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EventSource/EventSource.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SandBoxPreviewTool/SandBoxPreviewTool.framework"
